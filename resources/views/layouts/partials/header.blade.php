<header class="header">
    <div class="page-brand">
        <a class="link" href="index.html">
            <span class="brand">
                <img src="{{ asset('img/logo/horizontal-logo.png') }}" alt="Logo" style="height: 40px; width: auto;">
                <!-- Sesuaikan ukuran sesuai kebutuhan -->
            </span>
            <span class="brand-mini"><img src="{{ asset('img/logo/logo.png') }}" alt="Logo" style="height: 30px; width: 30px;"></span>
        </a>
    </div>
        ...
        <ul class="nav navbar-toolbar">
            ...
            <li class="dropdown dropdown-user">
                <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                    ...
                    <span></span>{{ session('user.name') }}<i class="fa fa-angle-down m-l-5"></i></a>
                <ul class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="profile.html"><i class="fa fa-user"></i>Profik</a>
