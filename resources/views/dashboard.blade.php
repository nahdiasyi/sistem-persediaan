            ...
            <div class="col-lg-3 col-md-6">
                <div class="ibox bg-success color-white widget-stat">
                    <div class="ibox-body">
                        ...
                        <div class="m-b-5">PERMINTAAN</div><i class="fa fa-arrow-down widget-stat-icon"></i>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="ibox bg-info color-white widget-stat">
                    <div class="ibox-body">
                        ...
                        <div class="m-b-5">BARANG MASUK</div><i class="fa fa-arrow-up widget-stat-icon"></i>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="ibox bg-warning color-white widget-stat">
                    <div class="ibox-body">
                        ...
                        <div class="m-b-5">BARANG KELUAR</div><i class="fa fa-arrow-down widget-stat-icon"></i>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="ibox bg-danger color-white widget-stat">
                    <div class="ibox-body">
                        ...
                        <div class="m-b-5">TOTAL PERSEDIAAN</div><i class="fa fa-box widget-stat-icon"></i>
